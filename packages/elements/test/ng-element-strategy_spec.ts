...
import {NgElementStrategy} from '../src/ng-element-strategy';
import {Subject} from 'rxjs/Subject';

fdescribe('NgElementStrategy', () => {
  let factory: FakeComponentFactory;
  let component: FakeComponent;
  let strategy: NgElementStrategy<FakeComponent>;
  let injector;
  ...
  beforeEach(() => {
    ...
    strategy = new NgElementStrategy(factory, injector);
  });
...
export class FakeComponentFactory extends ComponentFactory<any> {
  ...
  get componentType(): Type<any> { return {} as Type<any>; }
