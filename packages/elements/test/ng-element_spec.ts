...
if (supportsCustomElements()) {
  describe('NgElement', () => {
    ...
    [true, false].forEach(instantiateDirectly => {
      ...
      const description = `(instantiated ${methodStr}`;
      ...
      describe(description, () => {
          ...
          platformBrowserDynamic()
              ...
              .then(ref => {
                ...
                e = instantiateDirectly ? new TestNgElement() :
                                          document.createElement(selector) as any;
              })
              .then(done, done.fail);
        });
        ...
        describe('attributeChangedCallback()', () => {
          ...
          it('should update the corresponding property if component has not been created', () => {
        ...
        describe('connectedCallback()', () => {
          ...
          it('should create the component', () => {
            ...
            expect(e.textContent).toContain('TestComponent');
          });
          ...
          it('should initialize component inputs from attributes (if properties are not set)',
             () => {
               e.setAttribute('foo', 'newFoo');
               e.setAttribute('b-a-r', 'newBar');
               e.setAttribute('bar', 'ignored');
               e.setAttribute('bA-r', 'ignored');
               e.connectedCallback();
          ...
          it('should convert component output emissions to custom events', () => {
            ...
            e.addEventListener('BAZ', listeners.BAZOnNgElement);
            e.addEventListener('qux', listeners.quxOnHost);
            e.addEventListener('q-u-x', listeners['q-u-xOnHost']);
            e.connectedCallback();
            e.addEventListener('baz', listeners.bazOnHost);
            e.addEventListener('BAZ', listeners.BAZOnHost);
          ...
          it('should wire up the component for change detection', () => {
            ...
            expect(e.textContent).toBe(expectedContent1);

            e.componentRef !.instance.bar = 'newBar';
            appRef.tick();

            expect(detectChangesSpy).toHaveBeenCalledWith();
            expect(e.textContent).toBe(expectedContent2);
          });
        ...
        describe('disconnectedCallback()', () => {
          ...
          describe('after some delay', () => {
            ...
            it('should stop converting component output emissions to custom events', () => {
              ...
              expect(listenerForConnected).toHaveBeenCalledTimes(2);
